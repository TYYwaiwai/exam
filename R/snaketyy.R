X11(type="Xlib")
source(file="D:/RStudio/tanchishe/R/gametyy.R")
# library(tuneR)
library(beepr)
...
Snake<-setRefClass("Snake",contains="Game",
   methods=list(
     ...
     stage0=function(){
       ...
       text(0.2,0.05,label="319891504",cex=1)
       text(0.5,0.05,label="3198911504",cex=1)
     },
     stage2=function(){
       callSuper()
       ...
       text(0.2,0.05,label="3198911504",cex=1)
       text(0.5,0.05,label="3198911504",cex=1)
     },
     # 新增stage3，用来表示暂停状态
     stage3=function(){
